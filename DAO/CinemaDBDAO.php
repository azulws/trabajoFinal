<?php
    ...
    public function Add( Cinema $cinema){
        ...
        $sql = "INSERT INTO $this->tablename (cinema_name,ticket_value,address) VALUES (:cinema_name, :ticket_value, :address)";
    ...
    public function Update(Cinema $cinema){
      ...
      $sql = "UPDATE $this->tablename SET ticket_value = :ticket_value WHERE cinema_name = :cinema_name";
      $parameters['cinema_name'] = $cinema->getName();
      $parameters['ticket_value'] = $cinema->getTicketValue();
