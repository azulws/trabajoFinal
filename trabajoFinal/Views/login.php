<form class="login" action="<?php echo FRONT_ROOT."Login/receiveAction";?>" method="POST"> 
    <h2>Bienvenido</h2>
    <fieldset>
        <input type="email" class="email" placeholder="mail" name="user_mail" require>
        <input type="password" class="password" placeholder="password" name="user_password" require>
    </fieldset>
