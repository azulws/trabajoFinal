<?php
    ...
    class TicketDBDAO
       ...
       public function readAllByUser($user){
        $sql = "SELECT t.ticket_id, t.qr, t.movieFunction_id, b.buyout_id FROM tickets as t 
       ...
       public function readAllByMovieFunction($movieFunctionId){
            $sql = "SELECT b.buyout_id, b.user_email, b.buy_date,b.cantTicket, b.total, b.discount FROM tickets as t 
            JOIN buyouts as b on b.buyout_id=t.buyout_id 
       ...
       public function Add($ticket){
           ...
           $sql = "INSERT INTO tickets (qr,movieFunction_id,buyout_id) VALUES (:qr,:movieFunction_id,:buyout_id)";
       ...
       public function Remove($id){
           $sql = "DELETE FROM tickets WHERE cantTicket = :id";
           $parameters['id'] = $id;
       ...
       {
           $sql = "SELECT * FROM tickets where cantTicket = :id";
           $parameters['id'] = $id;
           try
           {
               $this->connection = Connection::getInstance();
       ...
       public function Update ($ticket){
        $sql = "UPDATE tickets SET qr = :qr, movieFunction_id = :movieFunction_id, buyout_id = :buyout_id WHERE ticket_id = :ticket_id";
        $parameters['qr'] = $ticket->getqr();
        $parameters['movieFunction_id'] = $ticket->getmovieFunction()->getMovieFunctionId();
        $parameters['buyout_id'] = $ticket->getBuyout()->getId();
       ...
       public function countTicketsForFunction($movieFunction){
           $sql = "SELECT * FROM tickets WHERE movieFunction_id = :id";
